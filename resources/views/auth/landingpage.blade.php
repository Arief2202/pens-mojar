...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#features">Our Service</a></li>
            ...
            <div class="content d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-md-6 icon-box" data-aos="fade-up">
                  ...
                  <h4>Menetapkan Kuota Pengadaan Modul Ajar</h4>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                  <i class="bx bx-calendar-event"></i>
                  <h4>Menentukan Timeline Pengadaan Modul Ajar</h4>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                  <i class="bx bx-file-blank"></i>
                  <h4>Mengajukan Proposal Modul Ajar</h4>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
                  <i class="bx bx-edit-alt"></i>
                  <h4>Revisi Modul Ajar</h4>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
                  <i class="bx bx-desktop"></i>
                  <h4>Monitoring Pengadaan Modul Ajar</h4>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
                  <i class="bx bx-check"></i>
                  <h4>Approved Proposal Modul Ajar</h4>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-5">
            <div class="row">
              <div class="col-lg-6 info">
                <i class="bx bx-map"></i>
                <h4>Alamat</h4>
                <p>Jl. Raya ITS Sukolilo Kampus PENS</p>
              </div>
              <div class="col-lg-6 info">
              ...
              <div class="col-lg-6 info">
                ...
                <h4>Jam Kerja</h4>
                <p>Senin - Jum'at: 08.00AM - 16.30PM</p>
              </div>
            </div>
          </div>
  ...
  <footer id="footer">
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>A4 Team</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
