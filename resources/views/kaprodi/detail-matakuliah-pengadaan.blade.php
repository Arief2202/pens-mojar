...
@section('content')
<div class="container">
    <h1 class="tittle-utama">Pengadaan</h1>
    <h5 class="card-title tittle-login">Beranda / List Pengadaan / Detail</h5>
    <br>
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                            ...
                            <div class="card" style="border: none;">
                                <div class="card-body" id="line-card">
                                    <table class="table">
                                        ...
                                        <br>
                                        <tr id="garis">
                                            <th scope="row" class="tittle-th" id="text-color-detail">Ketua Tim Pengusul</th>
                                            <td id="tittle-td">: Tri Hadiah Muliawati, S.ST., M.Kom.</td>
                                        </tr>
                                        <tr id="garis">
                                            <th scope="row" class="tittle-th" id="text-color-detail">Anggota Tim Pengusul</th>
