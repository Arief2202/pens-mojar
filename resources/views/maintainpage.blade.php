...
<article>
    ...
    <h1>Page Still Under Maintain!</h1>
    <div>
        <p>Sorry for the inconvenience. We&rsquo;re performing some maintenance at the moment. If you need to you can <a href="mailto:#">contact us</a>, otherwise we&rsquo;ll be back up shortly!</p>
        <p>&mdash; RPL A4 Team</p>
    </div>
</article>