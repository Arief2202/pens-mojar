                                ...
                                <div class="card-body" id="line-card">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr id="garis">
                                            ...
                                            <tr id="garis">
                                                <th scope="row" class="tittle-th">Catatan Tim Reviewer</th>
                                                <td><div class="card mb-3" style="width: 18rem;">
                                                    <div class="card-body">
                                                      <p class="card-text">With supporting text below as a natural lead-in to additional content.</p></td>
                                                    </div>
                                                  </div>
                                        </tbody>
                                    </table>
